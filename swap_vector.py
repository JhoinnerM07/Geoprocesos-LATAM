...
try:
    ...
    esquema_mavvial, esquema_placa, capa_mavvial, capa_placa = dlg.get_values()

    if not all([esquema_mavvial, esquema_placa, capa_mavvial, capa_placa]):
        raise Exception("⚠️ Todos los campos son obligatorios.")

    # ========= CARGA DEL SCRIPT =========
    mostrar_mensaje("Descargando", "📥 Descargando el script desde GitHub...")
    url_sql = "https://raw.githubusercontent.com/JhoinnerM07/herramientas_automatizacion/refs/heads/main/swap_vector.sql"
